...
const closeContact = document.createElement("a");
closeContact.setAttribute("href", "https://www.google.com")
...
let imgPaths = ["../img/message.png", "../img/call.png", "../img/location.png" ]
...
closeContact.appendChild(closeButton);
div.appendChild(closeContact)
div.appendChild(h2)
